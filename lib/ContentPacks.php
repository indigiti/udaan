...
function content_pack_dir(): string { return data_path('content/packs'); }
function content_manifest_file(): string { return data_path('content/manifest.json'); }
function content_signing_key_file(): string { return data_path('content-signing.key'); }
