...
</style></head><body><main class="fit-wrap"><header class="fit-head"><a class="brand" href="<?=h(route_url('home'))?>"><span class="brand-mark">उ</span><span>Udaan Fit</span></a><div class="fit-actions"><a class="ghost" href="<?=h(app_url('coach'))?>">Coach</a><a class="ghost" href="<?=h(app_url('momentum'))?>">Momentum</a><a class="ghost" href="<?=h(app_url('today'))?>">Today</a><a class="ghost" href="<?=h(app_url('readiness'))?>">Readiness</a><a class="ghost" href="<?=h(app_url('progress'))?>">Progress</a><?=theme_toggle()?></div></header>
