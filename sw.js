const VERSION='udaan-v0.6.0';
const STATIC=`${VERSION}-static`;
const CORE=['./offline.html','./manifest.webmanifest','./assets/css/app.css?v=0.6.0','./assets/js/theme.js?v=0.6.0','./assets/js/pwa.js?v=0.6.0','./assets/js/learning-progress.js?v=0.6.0','./assets/js/journey.js?v=0.6.0','./assets/js/vault.js?v=0.6.0','./assets/js/device-id.js?v=0.6.0','./assets/js/content-packs.js?v=0.6.0','./assets/js/offline-learning.js?v=0.6.0','./assets/js/qoi.js?v=0.6.0','./assets/js/share-card.js?v=0.6.0','./offline-learning.php','./assets/js/qr-local.js?v=0.6.0','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
